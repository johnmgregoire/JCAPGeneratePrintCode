...
p=r'Z:\Documents\CaltechWork\platemaps\Epson6Elementcombinations_singleplate\0067-04-0100-mp.txt'
os.chdir(r'Z:\Documents\CaltechWork\platemaps\Epson6Elementcombinations_singleplate\smoothfiltermaps')
...
for count, inds4 in enumerate(combs4):
    ...
    p0='0067-04-0100-mp_subspace__%s.pck' %ellab
    ...
    p='0067-04-0100-mp_subspace_dneighbor_symm__%s.pck' %ellab

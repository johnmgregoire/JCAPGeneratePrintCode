...
newpath=r'D:\Google Drive\Documents\CaltechWork\platemaps\4x6_20intervs_rightcolumnsforcharacterization\v1.txt'
...
for count, (i, j) in enumerate([(0, 1), (0, 2), (0, 3), (1, 2), (1, 3), (2, 3)]):
    tempcomps=list(genbinarycomps(binintervs, i, j))+[numpy.zeros(4, dtype='float64')] #add 6 compositions in binary line and then zeros
    code=1000*(count+1)

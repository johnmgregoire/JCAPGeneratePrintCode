...
compsint2=[[b, c, (intervs-a-b-c), a] for a in numpy.arange(1,intervs+1, 2)[::-1] for b in numpy.arange(a,intervs+1-2*a) for c in numpy.arange(a, intervs+1-2*a-b)][::-1]
...
compsint2+=[cc for cc in compsint if 0 in cc and not (cc in compsint2)]
comps=numpy.float32(compsint2)/intervs
